...
const Contact = () => {
    ...
    const { data, isLoading, refetch } = useQuery(['frontContacts', pageNumber], () => fetch(`https://my-payra-server.onrender.com/contacts?pageNumber=${pageNumber}`, {
        method: 'GET',
        headers: {
    ...
    const onSubmit = data => {
        ...
        fetch('https://my-payra-server.onrender.com/blood-request', {
            method: 'POST',
            headers: {
                'content-type': 'application/json'
            },
