...
const Upazila = () => {
    ...
    const { data, isLoading, refetch } = useQuery(['upazila', upazilaLimit, upazilaPageNumber, upazilaSearchData], () => fetch(`https://my-payra-server.onrender.com/upazilas?upazilaLimit=${upazilaLimit}&upazilaPageNumber=${upazilaPageNumber}&upazilaSearchData=${upazilaSearchData}`, {
        method: 'GET',
        headers: {
