...
const AvailableDonor = () => {
    ...
    const { data, isLoading, refetch } = useQuery(['availableDonorList', limit, pageNumber, sortByDonateCount, donorSearchData, selectedUnion, villageFilterData, bloodGroupFilterData, selectedUpazila, selectedDivision, selectedDistrict], () => fetch(`https://my-payra-server.onrender.com/available-donor?limit=${limit}&pageNumber=${pageNumber}&sortByDonateCount=${sortByDonateCount}&donorSearchData=${donorSearchData}&unionFilterData=${unionFilterData}&villageFilterData=${villageFilterData}&bloodGroupFilterData=${bloodGroupFilterData}&upazilaFilterData=${upazilaFilterData}&districtFilterData=${districtFilterData}&divisionFilterData=${divisionFilterData}`, {
        method: 'GET',
        headers: {
    ...
    const { data: divisionData, divisionIsLoading } = useQuery(['allDivisions'], () => fetch('https://my-payra-server.onrender.com/divisions', {
        method: 'GET',
        headers: {
            'content-type': 'application/json',
            authorization: `Bearer ${localStorage.getItem('accessToken')}`
    ...
    const { data: districtData, districtIsLoading } = useQuery(['allDistricts'], () => fetch('https://my-payra-server.onrender.com/districts', {
        method: 'GET',
        headers: {
            'content-type': 'application/json',
            authorization: `Bearer ${localStorage.getItem('accessToken')}`
    ...
    const { data: upazilaData, upazilaIsLoading } = useQuery(['allUpazilas'], () => fetch('https://my-payra-server.onrender.com/upazilasForForm', {
        method: 'GET',
        headers: {
            'content-type': 'application/json',
            authorization: `Bearer ${localStorage.getItem('accessToken')}`
    ...
    const { data: unionData, unionIsLoading } = useQuery(['allunions'], () => fetch('https://my-payra-server.onrender.com/unionsForForm', {
        method: 'GET',
        headers: {
            'content-type': 'application/json',
            authorization: `Bearer ${localStorage.getItem('accessToken')}`
    ...
    const { data: villageData, villageIsLoading } = useQuery(['allvillage'], () => fetch('https://my-payra-server.onrender.com/villagesForForm', {
        method: 'GET',
        headers: {
            'content-type': 'application/json',
            authorization: `Bearer ${localStorage.getItem('accessToken')}`
